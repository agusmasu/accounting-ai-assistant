...
def send_text_message(base_url, phone_number, message):
    """Send a simulated text message to the webhook"""
    webhook_url = f"{base_url}/webhook/whatsapp?test_mode=true"
...
def send_image_message(base_url, phone_number):
    """Send a simulated image message to the webhook"""
    webhook_url = f"{base_url}/webhook/whatsapp?test_mode=true"
...
def main():
    ...
    parser.add_argument("--url", required=True, help="Base URL of the webhook (e.g., https://your-ngrok-url.ngrok.io)")
    ...
    parser.add_argument("--type", choices=["text", "image", "verify"], default="text", help="Type of request to send (default: text)")
    ...
    if args.type == "text":
        ...
        send_image_message(args.url, args.phone)
